...
rand_players = random.sample(range(16, int(len(season_df)-len(season_df)*.5)), 5) + list(range(15))


p1 =sns.scatterplot(x="per_win", y="total_wins", data=season_df, hue='max_win', alpha=.5)
